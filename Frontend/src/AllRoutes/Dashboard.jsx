    ...
    if(loading){
        ...
        if(data.id){
            ...
            return (
                <>
                    <Navbar/>
                    <Box mt="30px" display="flex" justifyContent="end" paddingRight="5%"><Button onClick={handleRefresh}>Refresh List</Button></Box>
                    <Box w="90%" m="auto" mt="30px" display="grid" gridTemplateColumns="repeat(3,1fr)" gap="20px">
                       {data && data.columns.map((el)=>{
                        ...
                        <Heading width="100%" fontWeight="500" textAlign="center" height="50px" borderBottom="1px solid gray">{el}</Heading>
